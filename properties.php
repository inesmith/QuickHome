...
<body>
    ...
    <!-- Hero Image Section -->
    <div class="hero" style="display: flex; justify-content: center; align-items: center; margin-top: -350px; flex-direction: column; border-radius: 5px">
        <!-- Hero Block -->
        ...
        <!-- Image and Content -->
        <img src="images/Frame 70.png" style="height: 100px; width: auto; cursor: pointer; border-radius: 10px; margin-top:50px; margin-left:-80px" onclick="document.getElementById('additional-content').style.display='block'">  
        
        <!-- Hidden Content that becomes visible -->
        <div id="additional-content" style="display: none; margin-top: 20px;"> <!-- Initially hidden -->
            <!-- New Hero Block -->
